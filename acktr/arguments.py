...
def get_args():
    ...
    parser.add_argument(
        '--entropy_coef', default=0.005, type=float,  help='entropy term coefficient (default: 0.01)'
    )
    parser.add_argument(
        '--value_loss_coef', default=0.5, type=float,  help='value loss coefficient (default: 0.5)'
    )
    parser.add_argument(
        '--invalid_coef', default=2.0, type=float,  help='invalid action possibility term coefficient'
    )
    parser.add_argument(
    ...
    parser.add_argument(
        '--num_processes', default=5, type=int,  help='how many training CPU processes to use (default: 16)'
    )
    parser.add_argument(
    ...
    parser.add_argument(
        '--num_steps', default=80, type=int,  help='number of forward steps in A2C (default: 10)'
    )
    parser.add_argument(
